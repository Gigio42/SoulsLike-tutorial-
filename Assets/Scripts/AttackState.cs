...
namespace Dark
{
    public class AttackState : State
    {
        ...
        public override State Tick(EnemyManager enemyManager, EnemyStats enemyStats, EnemyAnimatorManager enemyAnimatorManager)
        {
            ...
            {
                // if close => current attack, get new
                if(enemyManager.distanceFromTarget < currentAttack.minimumDistanceNeededToAttack) return this;
                ...
                else if(enemyManager.distanceFromTarget < currentAttack.maximumDistanceNeededToAttack)
                {
                    ...
                    {
                        if (enemyManager.currentRecoveyTime <= 0 
                        && enemyManager.isPerformingAction == false)
                        {
                            ...
                            enemyManager.currentRecoveyTime = currentAttack.recoveryTime;
                            currentAttack = null;
